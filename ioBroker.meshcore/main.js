...
const MeshCore = require("@liamcottle/meshcore.js");
...
class Meshcore extends utils.Adapter {
	...
	async onReady() {
		...
		this.log.info("Meshcore adapter started");

 		this.log.info(`transport=${this.config.transport}`);
		this.log.info(`host=${this.config.host}`);
		this.log.info(`port=${this.config.port}`);
		this.log.info(`serialPort=${this.config.serialPort}`);
		/*
